        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/tifton" className="text-gray-400 hover:text-white transition-colors">
                  City of Tifton
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start">
                ...
                <a 
                  href="https://maps.google.com/?q=2508+Carpenter+rd+Tifton+GA+31793" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors"
                >
                  2508 Carpenter Rd.<br />
                  Tifton, GA 31793
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="tel:229-382-4411" className="hover:text-white transition-colors">
                  229-382-4411
                </a>
              </li>
              <li className="flex items-center">
